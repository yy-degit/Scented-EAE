...
def convert_to_shorter_oneie(input_path: str,
                             output_path: str,
                             tokenizer: PreTrainedTokenizer):
    """Converts files to OneIE format.
...
def split_data(input_file: str,
    ...
    """
    print('Splitting the dataset into train/valid/test sets')
...
if __name__ == '__main__':
    ...
    convert_to_shorter_oneie(json_path, oneie_path, tokenizer=tokenizer)
